...
# 編輯 ~/.zshrc
POWERLEVEL10K_LEFT_PROMPT_ELEMENTS=(dir vcs) # 加上 "vcs"

# 加上 "dir_writable"
POWERLEVEL10K_LEFT_PROMPT_ELEMENTS=(dir dir_writable vcs)

# 加上 "vi_mode"
POWERLEVEL10K_LEFT_PROMPT_ELEMENTS=(dir dir_writable vcs vi_mode)

# 加上 "status" 顯示上一個指令的 return code：
POWERLEVEL10K_RIGHT_PROMPT_ELEMENTS=(status time)

# 加上 ram，顯示目前的 free memory
POWERLEVEL10K_RIGHT_PROMPT_ELEMENTS=(status ram time)

POWERLEVEL10K_MODE="nerdfont-complete"

# 加上 load 顯示 CPU 忙碌程度
POWERLEVEL10K_RIGHT_PROMPT_ELEMENTS=(status ram load time)

POWERLEVEL10K_RIGHT_PROMPT_ELEMENTS=(battery)
